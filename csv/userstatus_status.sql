...
CREATE TABLE `status` (
  ...
  `namestatus` varchar(50) CHARACTER SET utf16 COLLATE utf16_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `status` VALUES (1,'Đã duyệt - LT'),(2,'Thi xong - LT'),(3,'Đã duyệt - TH'),(4,'Thi xong - TH'),(5,'=> Thi đường trường');

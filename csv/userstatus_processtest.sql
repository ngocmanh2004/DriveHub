...
--
-- Table structure for table `processtest`
--
...
--
-- Dumping data for table `processtest`
--

LOCK TABLES `processtest` WRITE;
/*!40000 ALTER TABLE `processtest` DISABLE KEYS */;
INSERT INTO `processtest` VALUES (1,'Chưa thi',NULL,NULL),(2,'Đang thi',NULL,NULL),(3,'Hoàn thành',NULL,NULL);
/*!40000 ALTER TABLE `processtest` ENABLE KEYS */;
UNLOCK TABLES;
